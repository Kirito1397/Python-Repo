# def isValidChessBoard(input_dict):
#     chess = {'black_piece': ['bking','bqueen','brook','bpawn','bbishop','bknight'],
#              'white_piece': ['wking','wqueen','wrook','wpawn','wbishop','wknight'],
#              'locations' : [ ['1','2','3','4','5','6','7','8'],['a','b','c','d','e','f','g','h'] ] }

#     print(input_dict)

#     temp = {input_dict.values()}

#     print(temp)

#     for j in temp:
#         if j not in chess["black_piece"] or chess["white_piece"]:
#             print("False")
        
# isValidChessBoard(input())
